...
It is possible. However, setting up a custom Anaconda environment and using that specific Python version is not apparent. It is possible if you have some time to figure out from Stackoverflow and some GitHub issue queues.
